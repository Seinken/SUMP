...
namespace SUMP
{
    partial class Program
    {
        ...
        private static byte[] GetSleepBytes(byte[] fileBuffer)
        {
            ...
            byte[] sig2 = new byte[] { 0x8B, 0x4D, 0xB8, 0x0B, 0x4D, 0xBC, 0x0F, 0x84 }; //6.x clients & 7.x clients
        ...
        private static bool GetInjectionAddress(byte[] fileBuffer, out int offset)
        {
            ...
            byte[] sig4 = new byte[] { 0x83, 0xC4, 0x04, 0x01, 0x44, 0x24, 0x40 }; //7.x clients
            offset = 0;
            ...
            if (FindSignatureOffset(sig4, fileBuffer, out offset))
            {
                offset += 0x0C;
                return true;
            }
